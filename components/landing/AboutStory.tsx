...
const reasons = [
  ...
  },
  {
    ...
    text: 'Мугалимдер сабакты окуу эмес, жеке темп жана мотивацияны сактоо деп түшүнөт. Кичи топ — ар бир окуучуга көним.',
  },
  {
    num: '03',
    title: 'Ата-эне үчүн ачыктык',
    text: 'Бала эмне үйрөнгөнүн, кандай прогресске жеткенин түшүнүү оңой. Сиз процессте, бала эсе эмес.',
  },
  {
    num: '04',
        ...
        <div className="grid gap-10 lg:grid-cols-12 lg:gap-12">
          ...
          >
            ...
            <p className="mt-4 text-sm leading-relaxed text-slate-400 sm:text-base">
              Okurmen Kids — Okurmen брендинин балдар багыты. Биз структураланган программа, практикалык
              долбоорлор жана менторлук менен IT негиздерин беребиз. Максат — бир эле курс эмес, узак мөөнөттүү
              IT жолун ачуу.
            </p>
