...
export default function TrialLessonCta() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setSuccess(true);
      setForm({ childName: '', parentPhone: '', childAge: '', courseInterest: '', comment: '' });
  ...
  return (
    <section id="trial-lesson" className="section-layer">
        ...
        <div className="grid items-start gap-10 lg:grid-cols-2 lg:gap-16 xl:gap-20">
          ...
          >
            ...
            <p className="mt-4 max-w-md text-sm leading-relaxed text-slate-400 sm:text-base">
              Баланын IT багытына кызыгуусун биринчи сабакта көрүңүз. Менеджер сиз менен байланышып, ылайыктуу убакыт
              дайындайт.
            </p>
          ...
          >
            <div className="relative flex items-end justify-center lg:justify-end" aria-hidden>
              <Image
                ...
                alt="Пробный сабакка жазылуу — ментор ноутбук менен"
                width={360}
                height={360}
